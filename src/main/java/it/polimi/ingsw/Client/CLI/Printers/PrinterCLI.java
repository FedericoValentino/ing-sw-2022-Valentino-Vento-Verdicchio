...
public abstract class PrinterCLI
{
    ...
    public static void printTitle()
    {
        ...
        array[0] = ".----------------.  .----------------.  .----------------.  .----------------.  .-----------------. .----------------.  .----------------.  .----------------.  ";
        array[1] = "| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |";
        array[2] = "| |  _________   | || |  _______     | || |     _____    | || |      __      | || | ____  _____  | || |  _________   | || |     _____    | || |    _______   | |";
        array[3] = "| | |_   ___  |  | || | |_   __ \\    | || |    |_   _|   | || |     /  \\     | || ||_   \\|_   _| | || | |  _   _  |  | || |    |_   _|   | || |   /  ___  |  | |";
        array[4] = "| |   | |_  \\_|  | || |   | |__) |   | || |      | |     | || |    / /\\ \\    | || |  |   \\ | |   | || | |_/ | | \\_|  | || |      | |     | || |  |  (__ \\_|  | |";
        array[5] = "| |   |  _|  _   | || |   |  __ /    | || |      | |     | || |   / ____ \\   | || |  | |\\ \\| |   | || |     | |      | || |      | |     | || |   '.___`-.   | |";
        array[6] = "| |  _| |___/ |  | || |  _| |  \\ \\_  | || |     _| |_    | || | _/ /    \\ \\_ | || | _| |_\\   |_  | || |    _| |_     | || |     _| |_    | || |  |`\\____) |  | |";
        array[7] = "| | |_________|  | || | |____| |___| | || |    |_____|   | || ||____|  |____|| || ||_____|\\____| | || |   |_____|    | || |    |_____|   | || |  |_______.'  | |";
        array[8] = "| |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |";
        array[9] = "| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |";
        array[10] = " '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' ";
        for(int i = 0; i < 11; i++)
        {
            AnsiConsole.out().println(ANSI_BLUE + array[i] + ANSI_RESET);
        }
    }
